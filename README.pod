...
This version is under development. See
...
Add ability to use synfrag as a proxy (similar to netcat), allowing full
connections to be tunneled through synfrag. Requires implementing more of a
real TCP/IP stack.
